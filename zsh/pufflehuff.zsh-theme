# Based on simnalamburt/shellder
...
# Shows a lamda or an x if there was an error last command.
prompt_symbol() {
  ...
  # prompt_segment 'NONE' $symbol_color "$symbol"
  prompt_segment $1 'NONE' $symbol_color "%B$symbol%b"
}
...
prompt_git() {
  ...
  if $(git rev-parse --is-inside-work-tree 2>/dev/null); then
    ...
    prompt_segment $1 $bgcolor foreground
    ...
    right_arrow $bgcolor
    # prompt_segment $1 'NONE' foreground "OK"
  fi
}

# Dir: current working directory
prompt_dir() {
  prompt_segment $1 'NONE' magenta '%20<…<%~'
}
